						...
						<TD COLSPAN=3>
							<TABLE CELLSPACING=0 CELLPADDING=0 WIDTH="100%">
								<TR VALIGN=BOTTOM>
									...
									<TD ALIGN=right><A CLASS=menu HREF="gameLog.php?act=returnpage&c=action4.php">GameLog</A>
														...
														<TR>
															<TD CLASS=borderred BGCOLOR="#FFFFBB">
																<TABLE WIDTH=100%>
																	...
																	<TR>
																		<TD WIDTH=50%><A HREF="action4.php"><IMG SRC="game/reef/images/a4.jpg" WIDTH="50" HEIGHT="32" ALIGN=LEFT BORDER=0> <B>Action 4:</B></A></B> Introduce a shrimp<BR>(only once per turn)</TD>
																						...
																						<DIV STYLE="left:0px; top:0px; width:340; height:291; position:relative; border: solid 1px black;"><SPAN ID="map" STYLE="left:0; top:0; position:absolute; z-index:100;"><IMG SRC="game/reef/images/b0.jpg" ></SPAN>
																							...
																							if (is_numeric($r))
																							{
																								if ($r !=1)
																								{
																									...
																									fwrite($fp, "You clicked on action 4.<br>");
																								}
																							}
																							...
																							function placeTarget0() 
																							{
																								...
																								foreach ($b0 as $el) 
																								{
																										echo "<span style='left:" . left1($el) . "; top:" . top1($el) . "; width:0px; height: 0px; position:absolute; z-index:501;'> <a href='hw6.php?act=placeshrimp&b0=0&c=". $el ."'>[+]</a></span>" . kEOL;
																								}
																							}
																							function left1($el)
																							{
																					...
																					<TD>
																						<DIV STYLE="left:0px; top:0px; width:340; height:291; position:relative; border: solid 1px black;"><SPAN ID="map" STYLE="left:0; top:0; position:absolute; z-index:100;"><IMG SRC="game/reef/images/b3.jpg" ></SPAN>
																							...
																							function placeTarget1() 
																							{
																								...
																								foreach ($b0 as $el) 
																								{
																								echo "<span style='left:" . left3($el) . "; top:" . top3($el) . "; width:0px; height: 0px; position:absolute; z-index:501;'> <a href='hw6.php?act=placeshrimp&b0=0&c1=". $el ."'>[+]</a></span>" . kEOL;
																								}
																							}
																							function left3($el)
																							{
