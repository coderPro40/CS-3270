						...
						<TD COLSPAN=3>
							<TABLE CELLSPACING=0 CELLPADDING=0 WIDTH="100%">
								<TR VALIGN=BOTTOM>
									...
									<TD ALIGN=right><A CLASS=menu HREF="gameLog.php?act=returnpage&g=hw6.php">GameLog</A>
									...
									<TD ALIGN=right><A CLASS=menu HREF="rules.htm">Rules</A>
                                                                        ...
                                                                        // script for handling game saving and saved game display 
												...
												<TD CLASS=border>
													<TABLE CELLSPACING=0 CELLPADDING=3 WIDTH=100%>
														...
														<TR ALIGN=CENTER VALIGN=TOP BGCOLOR=#FFFF70>
															...
															<TD CLASS=thin>&nbsp;</TD><TD CLASS=thin>&mdash;</TD><TD CLASS=thin>
																<TABLE CELLSPACING=0 CELLPADDING=0>
																	<TR>
																		<?php include_once "playerInfo.php";
																			player1();
																		?>
															<TD>&nbsp;</TD>
															<TD>&nbsp;</TD>
														...
														<TR ALIGN=CENTER VALIGN=TOP >
															<TD CLASS=thin ALIGN=LEFT>
																<TABLE CELLSPACING=0 CELLPADDING=0>
																	<TR>
																		<TD><IMG SRC='images/G.gif' WIDTH=16 HEIGHT=16 ALT='P' ALIGN=ABSMIDDLE>&nbsp;</TD>
																		<TD>Player2</TD>
																	</TR>
																</TABLE>
															</TD>
															...
															<TD CLASS=border>
																<TABLE>
																	<TR>
																		...
																		<TD></TD>
																		<?php include_once "BehindYourScreen.php";
																		polypTilesArray();
																		?>
																	</TR>
																...
																<TABLE WIDTH=100%>
																	<TR ALIGN=CENTER>
																		<TD>
																			<TABLE CELLSPACING=0 CELLPADDING=0>
																				<TR>
																					<?php include_once "parrotFish.php";
																					parrotFish();
																					?>
																					<TD>&nbsp;</TD>
																				</TR>
														...
														<TR>
															<TD CLASS=borderred BGCOLOR="#FFFFBB">
																<TABLE WIDTH=100%>
																	...
																	<TR>
																		<?php include_once "action4Disable.php"; action4ED();?>
