<?php
    function placeTarget0() 
    {
        ...
        {   // where player chooses position of shrimp
            echo "<span style='left:" . left1($el) . "; top:" . top1($el) . "; width:0px; height: 0px; position:absolute; z-index:501;'> <a href='hw7db.php?act=placeshrimp&b0=0&c=". $el ."&r=1'>[+]</a></span>" . kEOL;
        }
    }
    function left1($el)
    {
    ...
    function placeTarget1() 
    {
        ...
        foreach ($b0 as $el) 
        {
        echo "<span style='left:" . left3($el) . "; top:" . top3($el) . "; width:0px; height: 0px; position:absolute; z-index:501;'> <a href='hw7db.php?act=placeshrimp&b0=0&c1=". $el ."&r=1'>[+]</a></span>" . kEOL;
        }
    }
    function left3($el)
    {
